...
require_text("project.yml", r"CURRENT_PROJECT_VERSION:\s*9\b", "project.yml build number is 9")
...
require_text(".github/workflows/app-store-upload.yml", r'APP_STORE_CONNECT_BUILD_NUMBER:\s*"9"', "App Store upload workflow targets build 9")
...
require_text("HTMLMarkdownPreviewer.xcodeproj/project.pbxproj", r"CURRENT_PROJECT_VERSION = 9;", "generated Xcode project build number is 9")
