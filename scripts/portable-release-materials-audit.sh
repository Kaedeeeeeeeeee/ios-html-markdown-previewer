...
require_text("project.yml", r"CURRENT_PROJECT_VERSION:\s*8\b", "project.yml build number is 8")
require_text("project.yml", r"MARKETING_VERSION:\s*1\.4\b", "project.yml marketing version is 1.4")
...
require_text(".github/workflows/app-store-upload.yml", r'APP_STORE_CONNECT_BUILD_NUMBER:\s*"8"', "App Store upload workflow targets build 8")
require_text(".github/workflows/app-store-upload.yml", r'APP_STORE_CONNECT_VERSION_STRING:\s*"1\.4"', "App Store upload workflow targets version 1.4")
...
require_text("HTMLMarkdownPreviewer.xcodeproj/project.pbxproj", r"MARKETING_VERSION = 1\.4;", "generated Xcode project marketing version is 1.4")
require_text("HTMLMarkdownPreviewer.xcodeproj/project.pbxproj", r"CURRENT_PROJECT_VERSION = 8;", "generated Xcode project build number is 8")
