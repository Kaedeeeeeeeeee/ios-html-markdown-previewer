...
require_text("project.yml", r"CURRENT_PROJECT_VERSION:\s*7\b", "project.yml build number is 7")
require_text("project.yml", r"MARKETING_VERSION:\s*1\.3\b", "project.yml marketing version is 1.3")
...
require_text(".github/workflows/app-store-upload.yml", r'APP_STORE_CONNECT_BUILD_NUMBER:\s*"7"', "App Store upload workflow targets build 7")
require_text(".github/workflows/app-store-upload.yml", r'APP_STORE_CONNECT_VERSION_STRING:\s*"1\.3"', "App Store upload workflow targets version 1.3")
...
require_text("HTMLMarkdownPreviewer.xcodeproj/project.pbxproj", r"MARKETING_VERSION = 1\.3;", "generated Xcode project marketing version is 1.3")
require_text("HTMLMarkdownPreviewer.xcodeproj/project.pbxproj", r"CURRENT_PROJECT_VERSION = 7;", "generated Xcode project build number is 7")
...
require_text("docs/github-actions-troubleshooting.md", r"--attempt <attempt-number>", "Actions troubleshooting documents rerun attempt diagnostics")
