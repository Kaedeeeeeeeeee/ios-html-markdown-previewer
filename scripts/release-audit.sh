...
require_text "project.yml" "CURRENT_PROJECT_VERSION: 9" "project.yml build number is 9"
...
require_text "HTMLMarkdownPreviewer.xcodeproj/project.pbxproj" "CURRENT_PROJECT_VERSION = 9;" "generated Xcode project build number is 9"
...
require_text ".github/workflows/app-store-upload.yml" "APP_STORE_CONNECT_BUILD_NUMBER: \"9\"" "App Store upload workflow targets build 9"
