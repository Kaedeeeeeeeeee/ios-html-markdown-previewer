...
require_text "project.yml" "CURRENT_PROJECT_VERSION: 2" "project.yml build number is 2"
...
require_text "HTMLMarkdownPreviewer.xcodeproj/project.pbxproj" "CURRENT_PROJECT_VERSION = 2;" "generated Xcode project build number is 2"
