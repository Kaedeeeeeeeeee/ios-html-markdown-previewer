...
require_text "project.yml" "CURRENT_PROJECT_VERSION: 8" "project.yml build number is 8"
require_text "project.yml" "MARKETING_VERSION: 1\\.4" "project.yml marketing version is 1.4"
require_text "HTMLMarkdownPreviewer.xcodeproj/project.pbxproj" "MARKETING_VERSION = 1\\.4;" "generated Xcode project marketing version is 1.4"
require_text "HTMLMarkdownPreviewer.xcodeproj/project.pbxproj" "CURRENT_PROJECT_VERSION = 8;" "generated Xcode project build number is 8"
...
require_text ".github/workflows/app-store-upload.yml" "APP_STORE_CONNECT_BUILD_NUMBER: \"8\"" "App Store upload workflow targets build 8"
require_text ".github/workflows/app-store-upload.yml" "APP_STORE_CONNECT_VERSION_STRING: \"1\\.4\"" "App Store upload workflow targets version 1.4"
