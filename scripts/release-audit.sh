...
require_text "project.yml" "CURRENT_PROJECT_VERSION: 7" "project.yml build number is 7"
require_text "project.yml" "MARKETING_VERSION: 1\\.3" "project.yml marketing version is 1.3"
require_text "HTMLMarkdownPreviewer.xcodeproj/project.pbxproj" "MARKETING_VERSION = 1\\.3;" "generated Xcode project marketing version is 1.3"
require_text "HTMLMarkdownPreviewer.xcodeproj/project.pbxproj" "CURRENT_PROJECT_VERSION = 7;" "generated Xcode project build number is 7"
...
require_text ".github/workflows/app-store-upload.yml" "APP_STORE_CONNECT_BUILD_NUMBER: \"7\"" "App Store upload workflow targets build 7"
require_text ".github/workflows/app-store-upload.yml" "APP_STORE_CONNECT_VERSION_STRING: \"1\\.3\"" "App Store upload workflow targets version 1.3"
