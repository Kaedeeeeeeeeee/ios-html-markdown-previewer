...
require_text "project.yml" "CURRENT_PROJECT_VERSION: 5" "project.yml build number is 5"
require_text "project.yml" "MARKETING_VERSION: 1\\.2" "project.yml marketing version is 1.2"
require_text "HTMLMarkdownPreviewer.xcodeproj/project.pbxproj" "MARKETING_VERSION = 1\\.2;" "generated Xcode project marketing version is 1.2"
require_text "HTMLMarkdownPreviewer.xcodeproj/project.pbxproj" "CURRENT_PROJECT_VERSION = 5;" "generated Xcode project build number is 5"
...
require_text ".github/workflows/app-store-upload.yml" "APP_STORE_CONNECT_BUILD_NUMBER: \"5\"" "App Store upload workflow targets build 5"
require_text ".github/workflows/app-store-upload.yml" "APP_STORE_CONNECT_VERSION_STRING: \"1\\.2\"" "App Store upload workflow targets version 1.2"
