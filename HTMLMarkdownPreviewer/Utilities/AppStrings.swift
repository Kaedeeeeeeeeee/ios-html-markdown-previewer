...
enum AppStrings {
    ...
    enum SampleDesign {
        ...
        static let htmlSceneLabel = AppStrings.localized("sampleDesign.htmlSceneLabel", defaultValue: "Blue walking route between coffee, the riverside, and a bookshop.")
        static let htmlSceneTitle = AppStrings.localized("sampleDesign.htmlSceneTitle", defaultValue: "A little room to wander")
        static let htmlSceneCaption = AppStrings.localized("sampleDesign.htmlSceneCaption", defaultValue: "Follow the blue line. Leave the afternoon open.")
        static let htmlDay = AppStrings.localized("sampleDesign.htmlDay", defaultValue: "Daylight")
        static let htmlEvening = AppStrings.localized("sampleDesign.htmlEvening", defaultValue: "Evening")
        static let htmlPauseMotion = AppStrings.localized("sampleDesign.htmlPauseMotion", defaultValue: "Pause animation")
        static let htmlSceneHint = AppStrings.localized("sampleDesign.htmlSceneHint", defaultValue: "Try a different light, or pause the motion.")
        static let htmlPackingTitle = AppStrings.localized("sampleDesign.htmlPackingTitle", defaultValue: "Before you head out")
        static let htmlPackingBody = AppStrings.localized("sampleDesign.htmlPackingBody", defaultValue: "A book, a water bottle, and a little extra time. That is all you need.")
        static let htmlSceneCoffee = AppStrings.localized("sampleDesign.htmlSceneCoffee", defaultValue: "Coffee")
        static let htmlSceneBooks = AppStrings.localized("sampleDesign.htmlSceneBooks", defaultValue: "Books")
        static let htmlSceneRiverside = AppStrings.localized("sampleDesign.htmlSceneRiverside", defaultValue: "Riverside")
