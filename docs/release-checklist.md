...
- App Store handoff materials, including generated App Store Connect and final smoke result drafts plus final preflight evidence when available, can be staged with `scripts/prepare-release-packet.sh`.
