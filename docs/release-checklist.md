...
- App marketing version is set to `1.0` and build number is `4`.
- Release simulator build verifies `CFBundleShortVersionString=1.0`, `CFBundleVersion=4`, app icon assets, and privacy manifest in the app bundle.
