...
- App marketing version is set to `1.2` and build number is `6`.
- Release simulator build verifies `CFBundleShortVersionString=1.2`, `CFBundleVersion=6`, app icon assets, and privacy manifest in the app bundle.
